...
async def process_strike(ib, strike, expiry, ticker):
...
async def batch_data(ib: IB, batch_size, expiry, ticker, centre_price, up_level, down_level ):
    ...
    for i in range(0, len(strike_range), batch_size):
        ...
        batch_results = await asyncio.gather(
            *[process_strike(ib, strike, expiry, ticker) for strike in batch],
